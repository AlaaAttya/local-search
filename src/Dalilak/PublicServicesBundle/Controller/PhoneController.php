...
namespace Dalilak\PublicServicesBundle\Controller;
...
use Dalilak\PublicServicesBundle\Entity\Phone;
use Dalilak\PublicServicesBundle\Form\PhoneType;
...
class PhoneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DalilakPublicServicesBundle:Phone')->findAll();
     ...
     * @Method("POST")
     * @Template("DalilakPublicServicesBundle:Phone:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DalilakPublicServicesBundle:Phone')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DalilakPublicServicesBundle:Phone:edit.html.twig")
     */
