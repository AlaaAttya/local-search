...
use Dalilak\VenueBundle\Entity\Address;
use Dalilak\VenueBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DalilakVenueBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("DalilakVenueBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DalilakVenueBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DalilakVenueBundle:Address:edit.html.twig")
     */
